        ...
        <div id="create-feedbackM2W" class="content scaffold-create" role="main">
            ...
            <g:form action="save">
                <fieldset class="form">
                    ...
                    <g:select name="firstImpression" from="${com.speeddating.FeedbackM2W.FirstImpression.values()}" optionKey="key" multiple="true" size="7" />
                </div>
                    <div class="fieldcontain">
                    ...
                    <div class="fieldcontain">
                        ...
                        <g:select name="stoodOut" from="${com.speeddating.FeedbackM2W.StoodOut.values()}" optionKey="key" multiple="true" size="5" />
                    </div>
                    <div class="fieldcontain">
                    ...
                    <div class="fieldcontain">
                        ...
                        <g:select name="style" from="${com.speeddating.FeedbackM2W.Style.values()}" optionKey="key" multiple="true" size="6" />
                    </div>
                    <div class="fieldcontain">
                    ...
                    <div class="fieldcontain">
                        ...
                        <g:select name="howISpoke" from="${com.speeddating.FeedbackM2W.HowISpoke.values()}" optionKey="key" multiple="true" size="8" />
                    </div>
                    <div class="fieldcontain">
                    ...
                    <div class="fieldcontain">
                        ...
                        <g:select name="vibe" from="${com.speeddating.FeedbackM2W.Vibe.values()}" optionKey="key" multiple="true" size="8" />
                    </div>
                    <div class="fieldcontain">
