...
<html>
    ...
    <body>
        <a href="#edit-feedbackW2M" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-feedbackW2M" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.feedbackW2M}" method="PUT">
                <g:hiddenField name="version" value="${this.feedbackW2M?.version}" />
                <fieldset class="form">
                ...
                <div class="fieldcontain">
                    ...
                    <g:select name="firstImpression" from="${com.speeddating.FeedbackW2M.FirstImpression.values()}" optionKey="key" multiple="true" value="${feedbackW2M?.firstImpression}"/>
                </div>
                <div class="fieldcontain">
                ...
                <div class="fieldcontain">
                    ...
                    <g:select name="stoodOut" from="${com.speeddating.FeedbackW2M.StoodOut.values()}" optionKey="key" multiple="true" value="${feedbackW2M?.stoodOut}" />
                </div>
                <div class="fieldcontain">
                ...
                <div class="fieldcontain">
                    ...
                    <g:select name="style" from="${com.speeddating.FeedbackW2M.Style.values()}" optionKey="key" multiple="true" value="${feedbackW2M?.style}" />
                </div>
                <div class="fieldcontain">
                ...
                <div class="fieldcontain">
                    ...
                    <g:select name="howISpoke" from="${com.speeddating.FeedbackW2M.HowISpoke.values()}" optionKey="key" multiple="true" value="${feedbackW2M?.howISpoke}" />
                </div>
                <div class="fieldcontain">
                ...
                <div class="fieldcontain">
                    ...
                    <g:select name="vibe" from="${com.speeddating.FeedbackW2M.Vibe.values()}" optionKey="key" multiple="true" value="${feedbackW2M?.vibe}" />
                </div>
                <div class="fieldcontain">
