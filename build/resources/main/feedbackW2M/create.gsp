            ...
            <g:form action="save">
                <fieldset class="form">
                    ...
                    <div class="fieldcontain">
                        ...
                        <g:select name="firstImpression" from="${com.speeddating.FeedbackW2M.FirstImpression.values()}" optionKey="key" multiple="true" />
                    </div>
                    <div class="fieldcontain">
                    ...
                    <div class="fieldcontain">
                        ...
                        <g:select name="stoodOut" from="${com.speeddating.FeedbackW2M.StoodOut.values()}" optionKey="key" multiple="true" />
                    </div>
                    <div class="fieldcontain">
                    ...
                    <div class="fieldcontain">
                        ...
                        <g:select name="style" from="${com.speeddating.FeedbackW2M.Style.values()}" optionKey="key" multiple="true" />
                    </div>
                    <div class="fieldcontain">
                    ...
                    <div class="fieldcontain">
                        ...
                        <g:select name="howISpoke" from="${com.speeddating.FeedbackW2M.HowISpoke.values()}" optionKey="key" multiple="true" />
                    </div>
                    <div class="fieldcontain">
                    ...
                    <div class="fieldcontain">
                        ...
                        <g:select name="vibe" from="${com.speeddating.FeedbackW2M.Vibe.values()}" optionKey="key" multiple="true" />
                    </div>
                    <div class="fieldcontain">
