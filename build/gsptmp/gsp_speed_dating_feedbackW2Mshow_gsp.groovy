...
class gsp_speed_dating_feedbackW2Mshow_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/feedbackW2M/show.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(12)
invokeTag('display','f',22,['bean':("feedbackW2M")],-1)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(13)
createTagBody(3, {->
...
invokeTag('link','g',25,['class':("edit"),'action':("edit"),'resource':(this.feedbackW2M)],3)
printHtmlPart(14)
...
invokeTag('form','g',28,['resource':(this.feedbackW2M),'method':("DELETE")],2)
printHtmlPart(17)
})
