...
class gsp_speed_dating_feedbackM2Wshow_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/feedbackM2W/show.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(12)
invokeTag('display','f',22,['bean':("feedbackM2W")],-1)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(13)
createTagBody(3, {->
...
invokeTag('link','g',25,['class':("edit"),'action':("edit"),'resource':(this.feedbackM2W)],3)
printHtmlPart(14)
...
invokeTag('form','g',28,['resource':(this.feedbackM2W),'method':("DELETE")],2)
printHtmlPart(17)
})
